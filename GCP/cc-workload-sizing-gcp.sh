...
# Initialize counters
sum_total_gcp_vm_instances=0
sum_total_gke_nodes=0
sum_total_serverless_workloads=0
sum_total_storage_workloads=0
sum_total_caas_workloads=0
sum_total_container_image_workloads=0
sum_total_paas_workloads=0
sum_total_gcp_workloads=0
...
function count_gcp_resources_in_project {
    ...
    # Add to global sum
    sum_total_gcp_vm_instances=$((sum_total_gcp_vm_instances + total_vm_instances_proj))
    sum_total_gke_nodes=$((sum_total_gke_nodes + total_gke_nodes_proj))
    sum_total_serverless_workloads=$((sum_total_serverless_workloads + total_serverless_workloads_proj))
    sum_total_storage_workloads=$((sum_total_storage_workloads + total_storage_workloads_proj))
    sum_total_caas_workloads=$((sum_total_caas_workloads + total_caas_workloads_proj))
    sum_total_container_image_workloads=$((sum_total_container_image_workloads + total_container_image_workloads_proj))
    sum_total_paas_workloads=$((sum_total_paas_workloads + total_paas_workloads_proj))
...
while read -r org_data; do # Fix: Outer loop now uses process substitution
    ...
    echo ""
    echo "  -- GCP WORKLOAD COUNTS --"
    echo "     VM workloads: $sum_total_gcp_vm_instances"
    echo "     VM (container) workloads: $sum_total_gke_nodes"
    echo "     Serverless workloads: $sum_total_serverless_workloads"
    echo "     S3 workloads: $sum_total_storage_workloads"
    echo "     CaaS workloads: $sum_total_caas_workloads"
    echo "     Container Image workloads: $sum_total_container_image_workloads"
    echo "     PaaS workloads: $sum_total_paas_workloads"  
    echo ""

echo "$(tput bold)$(tput setaf 2)** SUM TOTAL GCP WORKLOADS: $sum_total_gcp_workloads **$(tput sgr0)"
echo ""